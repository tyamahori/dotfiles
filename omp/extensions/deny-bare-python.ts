...
// agents/global-instructions.md). TypeScript counterpart of the shared
// scripts/deny-bare-python-hook — keep both in sync. Matches python at a
// command position — start of string or after ; & | ( && || — optionally
// preceded by env-var assignments or `command`; `uv run python ...` is
