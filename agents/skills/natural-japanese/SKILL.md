...
description: 日本語の文章を、読みやすく・わかりやすく・AI臭くなく書く／直すためのスキル。議事録・レポート・ガイド・企画書・メール・スライド構成といった仕事の文書から、note記事・ブログ・エッセイまで、新規執筆でもリライトでも使う。AI臭い・不自然・機械翻訳っぽい・読みにくい・一文が長い・何が言いたいかわからない、といった指摘への対応、書き換えを伴わないAI臭さの採点・診断、ユーザーの文体のプロファイル化も担当する。Markdownの整形規約そのもの（一文一行化・脚注記法など）は japanese-tech-writing の領域。
license: MIT
