...
description: Load before writing or running any Python on this machine (one-off analysis, heredocs, helper or committed scripts) — uv invocation forms and when jq/shell/ax beat Python.
---
